...
namespace HRP.Data
{
    public class HrpData
    {
        public HrpData()
        {
            bahceModels = new List<BahceModel>()
            {
                new BahceModel()
                {
                    ...
                    Renk="Gold, Bronz, Black, Natural",
                    YuzeyTipi="Satin, Polished ",
                    TemizlikveBakim="HRP-F Care Products ",
                  ...
                  new BahceModel()
                {
                    ...
                    Renk="Gold, Bronz, Black, Natural ",
                    YuzeyTipi="Satin,Polished ",
                    TemizlikveBakim="HRP-F Care Product",
                   ...
                   new BahceModel()
                {
                    ...
                    YuzeyTipi="Satin,Polished ",
                    TemizlikveBakim="HRP-F Care Products ",
                    Doseme="Summer Plaın 042, Summer Plaın 220,Summer Plaın 540",
            ...
            icMekanModels = new List<icMekanModel>()
            {
                new icMekanModel()
                {
                    icMekanId=1,
                    ...
                    Yukseklik="2300 mm",
                    Malzeme="AISI 304 / AISI 316 (EN 1,4301, EN 1,4401)",
                    Renk=" Gold, Rose Gold, Black, Natural",
                    AhsapKaplama="Teak Moire, Rosewood Moire, Ebony Brown, Thick Grain Oak, Oak Extra, Platin",
                    YuzeyTipi="Satin, Polished ",
                    TemizlikveBakim=" HRP-F Care Products ",
                    Images= new List<Images>()
                    {
        ...
        public List<icMekanModel> icMekanModels { get; set; }
